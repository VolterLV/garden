...
window.onload = function () {
	...
	const weareImg = document.querySelector('.weare__image')
	const weareTitle = document.querySelector('.weare__title')
	const weareBody = document.querySelector('.weare__body')
	const mediaQuery = window.matchMedia('(max-width: 767.98px)')

	function handleTabletChange(e) {
		if (e.matches) {
			mainTitle.append(mainImg)
		} else {
			mainBody.append(mainImg)
		}

		if (e.matches) {
			weareTitle.append(weareImg)
		} else {
			weareBody.append(weareImg)
		}
	}
	...
	function documentActions(e) {
		...
		if (targetElement.classList.contains('dream__box-add')) {
			const productId = targetElement.closest('.dream__box-item').dataset.pid
	...
	function addToCart(productButton, productId) {
		if (!productButton.classList.contains('_hold')) {
			...
			const productImage = product.querySelector('.dream__box-img')
